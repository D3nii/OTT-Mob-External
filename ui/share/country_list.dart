...
class CountryList {
  static Country countryFromCode(String code) {
    // Default to Costa Rica if code is empty
    var defaultCountry = Country('Costa Rica', 'CR');
    ...
    for (Country country in CountryList.countryList) {
      if (country.code == code) {
        return country; // Return immediately when found
      }
    }

    // If not found, return a country with empty name
    return Country('', code);
  }
  ...
  static List<Country> countryList = [
    ...
    Country('Comoros', 'KM'),
    Country('Congo', 'CG'),
    Country('Congo, The Democratic Republic of ', 'CD'),
    ...
    Country('Reunion', 'RE'),
    Country('Romania', 'RO'),
    Country('Russia Federation', 'RU'),
    Country('Rwanda', 'RW'),
    Country('Saint Barthélemy', 'BL'),
    Country('Saint Helena', 'SH'),
    Country('Saint Kitts & Nevis', 'KN'),
    ...
    Country('South Georgia & The South Sandwich Islands', 'GS'),
    ...
    Country('Tunisia', 'TN'),
    Country('Turkey', 'TR'),
    Country('Turkish Rep N Cyprus', 'XT'),
